...
print("TradePilot Desktop Pilot 0.15.0 SELFTEST: OK")
...
assert ("Desktop Pilot 0.15.0" in _qml015) or ("Production REAL Core 0.16.0" in _qml015) or ("REAL Pilot Validation 0.16.1" in _qml015)
assert "1000 Stocks" in _qml015
assert ("REAL manuell bestätigt" in _qml015) or ("REAL Pilot Readiness integriert" in _qml015)
...
assert 'REAL_TEST_EUR = 1.00' in _pr
assert 'MAX_REAL_TRADE_EUR = 1.00' in _pr
