...
ApplicationWindow {
    ...
    visible: true
    color: "#010812"
    title: "TradePilot · " + (backend ? backend.version : "REAL Pilot Validation 0.16.1")
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { x: 84; y: 62; text: "REAL Pilot Validation 0.16.1"; color: "#6f8498"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        Item {
            ...
            NeonCard {
                ...
                Text { x: 20; y: 49; text: "Produktionssignale mit echten Marktdaten · AUTO SHADOW · REAL Pilot Readiness integriert"; color: "#8da2b6"; font.pixelSize: 11; font.family: "Segoe UI" }
            ...
            NeonCard {
                ...
                Text { x: 128; y: 476; text: backend ? backend.realPilotAmountText : "€1.00"; color: "#8FD2FF"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        Item {
            ...
            NeonCard {
                ...
                Text { x: 20; y: 49; text: "TradePilot REAL Pilot Validation · REAL AUTO default OFF"; color: "#8398ab"; font.pixelSize: 11; font.family: "Segoe UI" }
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "REAL Pilot Validation 0.16.1 · Scanner Optimization · Visual Polish II · 1000 Stocks"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
