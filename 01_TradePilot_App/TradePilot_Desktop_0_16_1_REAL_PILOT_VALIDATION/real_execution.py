...
class RealExecutionManager:
    """0.14.1 manual REAL validation transport. Fail closed, no automatic POST retry."""
    ...
    def execute_buy(self,prepared,confirmation,auto=False):
        if auto: raise RealExecutionError('REAL AutoTrading bleibt in 0.14.1 hart gesperrt.')
        self._assert_common()
