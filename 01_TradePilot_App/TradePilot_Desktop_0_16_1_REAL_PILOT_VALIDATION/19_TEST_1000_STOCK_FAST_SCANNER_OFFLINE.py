...
print('='*100)
print('TRADEPILOT 0.14.0 - 1000 STOCK + FINAL QUALITY GATE OFFLINE TEST')
print('='*100)
...
deep=[{'symbol':r['symbol'],'score':90-i*0.2,'signal':'BUY' if i<25 else 'WATCH','price':100.0,'rsi':60.0,'momentum_pct':1.5,'volume_ratio':2.0,'atr_pct':1.5} for i,r in enumerate(ranked)]
...
marked,naction=apply_quality_gate(marked,2,(),MAX_ACTIONABLE_SIGNALS)
...
print(f'Actionable-Gate:      {naction} (max 3)')
...
print('Neue Shadow BUYs:     ausschließlich ACTIONABLE (max 3)')
print('REAL Broker POST:     NICHT VERWENDET')
print('STATUS: 1000 STOCK + FINAL SIGNAL QUALITY GATE CORE OK')
