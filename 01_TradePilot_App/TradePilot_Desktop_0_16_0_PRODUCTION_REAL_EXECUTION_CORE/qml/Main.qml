...
ApplicationWindow {
    ...
    visible: true
    color: "#010812"
    title: "TradePilot · " + (backend ? backend.version : "Production REAL Core 0.16.0")
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { x: 84; y: 62; text: "Production REAL Core 0.16.0"; color: "#6f8498"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        Item {
            ...
            NeonCard {
                ...
                Text { x: 20; y: 49; text: "Produktionssignale mit echten Marktdaten · AUTO SHADOW · REAL manuell bestätigt"; color: "#8da2b6"; font.pixelSize: 11; font.family: "Segoe UI" }
        ...
        Item {
            ...
            NeonCard {
                ...
                Text { x: 20; y: 49; text: "TradePilot Production REAL Core · REAL AUTO default OFF"; color: "#8398ab"; font.pixelSize: 11; font.family: "Segoe UI" }
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "Production REAL Core 0.16.0 · Scanner Optimization · Visual Polish II · 1000 Stocks"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
