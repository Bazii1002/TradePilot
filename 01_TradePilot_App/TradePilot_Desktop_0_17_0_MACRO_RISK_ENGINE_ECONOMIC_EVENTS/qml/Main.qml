...
ApplicationWindow {
    ...
    visible: true
    color: "#010812"
    title: "TradePilot · " + (backend ? backend.version : "10 USD Pilot + Visible Scanner 0.16.3")
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { x: 84; y: 62; text: "10 USD Pilot + Visible Scanner 0.16.3"; color: "#6f8498"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        Item {
            ...
            NeonCard {
                ...
                Text { x: 20; y: 46; text: "Forecast · Previous · Actual · Relevanz · Countdown · Economic Surprise"; color: "#8398ab"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "10 USD Pilot + Visible Scanner 0.16.3 · Scanner Optimization · Visual Polish II · 1000 Stocks"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
