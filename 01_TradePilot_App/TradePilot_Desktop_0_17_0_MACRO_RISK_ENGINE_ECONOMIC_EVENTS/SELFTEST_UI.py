...
print("TradePilot Desktop 0.17.0 SELFTEST: OK")
...
assert ("Desktop Pilot 0.15.0" in _qml015) or ("Production REAL Core 0.16.0" in _qml015) or ("REAL Pilot Validation 0.16.1" in _qml015) or ("External REAL Position Validation 0.16.2" in _qml015) or ("10 USD Pilot + Visible Scanner 0.16.3" in _qml015)
...
assert ("REAL Pilot Validation 0.16.1" in qml) or ("External REAL Position Validation 0.16.2" in qml) or ("10 USD Pilot + Visible Scanner 0.16.3" in qml)
...
assert ('External REAL Position Validation 0.16.2' in qml) or ('10 USD Pilot + Visible Scanner 0.16.3' in qml)
