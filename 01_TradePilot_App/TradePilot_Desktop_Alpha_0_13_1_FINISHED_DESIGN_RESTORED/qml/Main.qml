...
ApplicationWindow {
    ...
    visible: true
    color: "#010812"
    title: "TradePilot · " + (backend ? backend.version : "Desktop Alpha 0.13.1")
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { x: 84; y: 62; text: "Desktop Alpha 0.13.1"; color: "#6f8498"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        Item {
            ...
            NeonCard {
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            width: 116; height: 42; radius: 8
                            color: bot && bot.level === modelData.l ? "#0d3155" : "#071521"
                            border.width: 1
                            border.color: bot && bot.level === modelData.l ? "#2f94e8" : "#1a3b53"
                            Text { anchors.centerIn: parent; text: modelData.l + "  " + modelData.n; color: bot && bot.level === modelData.l ? "#8fd2ff" : "#91a5b8"; font.pixelSize: 11; font.weight: Font.DemiBold; font.family: "Segoe UI" }
                            MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: if (bot) bot.setLevel(modelData.l) }
                        }
                    }
                }

                Rectangle {
                    x: 1084; y: 82; width: 130; height: 42; radius: 8
                    color: "#0d3155"; border.width: 1; border.color: "#2a6ea5"
                    Text { anchors.centerIn: parent; text: "SCAN NOW"; color: "#b9e2ff"; font.pixelSize: 11; font.weight: Font.DemiBold; font.family: "Segoe UI" }
                    MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: if (bot) bot.forceScan() }
                }
                Rectangle {
                    x: 1228; y: 82; width: 140; height: 42; radius: 8
                    color: bot && bot.running ? "#391921" : "#0b392d"
                    border.width: 1; border.color: bot && bot.running ? "#8c3345" : "#1d7452"
                    Text { anchors.centerIn: parent; text: bot && bot.running ? "STOP BOT" : "START BOT"; color: bot && bot.running ? "#ff9299" : "#39e795"; font.pixelSize: 11; font.weight: Font.DemiBold; font.family: "Segoe UI" }
                    MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: { if (bot) { if (bot.running) bot.stopBot(); else bot.startBot() } } }
                }
            }

            NeonCard {
                x: 0; y: 166; width: 824; height: 598
                glow: false; accentColor: "#8d64ff"
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        color: index % 2 === 0 ? "#071827" : "transparent"
                        Text { x: 10; y: 14; text: modelData.symbol; color: "#f4f7fb"; font.pixelSize: 13; font.weight: Font.DemiBold; font.family: "Segoe UI" }
                        Text { x: 122; y: 14; text: modelData.strategy; color: "#9d7dff"; font.pixelSize: 11; font.weight: Font.DemiBold; font.family: "Segoe UI" }
            ...
            NeonCard {
                ...
                Rectangle { x: 20; y: 55; width: 508; height: 76; radius: 10; color: "#071b21"; border.width: 1; border.color: "#16473b" }
                ...
                Rectangle { x: 20; y: 372; width: 508; height: 102; radius: 10; color: "#28161b"; border.width: 1; border.color: "#71313d" }
                Text { x: 36; y: 389; text: "REAL AUTOTRADING LOCKED"; color: "#ff7f89"; font.pixelSize: 12; font.weight: Font.DemiBold; font.family: "Segoe UI" }
                Text { x: 36; y: 417; width: 474; text: "Produktionssignale laufen im Shadow-Modus. Der REAL Execution Safety Core bleibt getrennt und gesperrt."; color: "#9cafbd"; font.pixelSize: 10; wrapMode: Text.WordWrap; font.family: "Segoe UI" }
            ...
            NeonCard {
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        Text { x: 10; y: 12; text: modelData.symbol; color: "#f4f7fb"; font.pixelSize: 13; font.weight: Font.DemiBold; font.family: "Segoe UI" }
        ...
        Item {
            ...
            NeonCard {
                ...
                Text { x: 20; y: 49; text: "Echte Marktdaten · Bewertung nach der aktuell gewählten FAST/DAY/WEEK/INVEST-Strategie"; color: "#8398ab"; font.pixelSize: 11; font.family: "Segoe UI" }
                Text { x: 22; y: 88; text: "SYMBOL"; color: "#6f879c"; font.pixelSize: 9; font.family: "Segoe UI" }
                Text { x: 170; y: 88; text: "STRATEGY"; color: "#6f879c"; font.pixelSize: 9; font.family: "Segoe UI" }
                Text { x: 355; y: 88; text: "SCORE"; color: "#6f879c"; font.pixelSize: 9; font.family: "Segoe UI" }
                Text { x: 485; y: 88; text: "REASON"; color: "#6f879c"; font.pixelSize: 9; font.family: "Segoe UI" }
                Text { anchors.right: parent.right; anchors.rightMargin: 34; y: 88; text: "SIGNAL"; color: "#6f879c"; font.pixelSize: 9; font.family: "Segoe UI" }
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        Text { x: 10; y: 13; text: modelData.symbol; color: "#f4f7fb"; font.pixelSize: 13; font.weight: Font.DemiBold; font.family: "Segoe UI" }
                        Text { x: 150; y: 13; text: modelData.strategy; color: "#9d7dff"; font.pixelSize: 11; font.family: "Segoe UI" }
            ...
            NeonCard {
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        Text { x: 115; y: 16; text: modelData.symbol; color: "#f4f7fb"; font.pixelSize: 12; font.weight: Font.DemiBold; font.family: "Segoe UI" }
                        ...
                        Text { x: 345; y: 16; text: modelData.strategy; color: "#9d7dff"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        Item {
            ...
            NeonCard {
                ...
                Rectangle {
                    ...
                    MouseArea { id: viewBotMouse; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: window.currentPage = 1 }
                }
            }
        }
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "Desktop Alpha 0.13.1 · Finished Design · Production Signals"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
