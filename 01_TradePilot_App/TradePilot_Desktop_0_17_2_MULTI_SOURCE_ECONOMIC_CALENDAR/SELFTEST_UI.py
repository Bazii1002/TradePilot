...
print("TradePilot Desktop 0.17.2 SELFTEST: OK")
...
assert ("REAL Pilot Validation 0.16.1" in qml) or ("External REAL Position Validation 0.16.2" in qml) or ("10 USD Pilot + Visible Scanner 0.16.3" in qml) or ("Economic Calendar Hardening 0.17.1" in qml) or ("Multi-Source Economic Calendar 0.17.2" in qml)
...
assert ('External REAL Position Validation 0.16.2' in qml) or ('10 USD Pilot + Visible Scanner 0.16.3' in qml) or ('Economic Calendar Hardening 0.17.1' in qml) or ('Multi-Source Economic Calendar 0.17.2' in qml)
...
assert ('Economic Calendar Hardening 0.17.1' in _qml17) or ('Multi-Source Economic Calendar 0.17.2' in _qml17)
