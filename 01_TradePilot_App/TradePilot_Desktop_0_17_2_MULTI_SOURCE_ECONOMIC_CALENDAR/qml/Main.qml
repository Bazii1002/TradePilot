...
ApplicationWindow {
    ...
    visible: true
    color: "#010812"
    title: "TradePilot · " + (backend ? backend.version : "Multi-Source Economic Calendar 0.17.2")
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { x: 84; y: 62; text: "Multi-Source Economic Calendar 0.17.2"; color: "#6f8498"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        Item {
            ...
            NeonCard {
                ...
                Text { x: 20; y: 49; text: "Produktionssignale mit echten Marktdaten · AUTO SHADOW · REAL Pilot Readiness + External Position Observer"; color: "#8da2b6"; font.pixelSize: 11; font.family: "Segoe UI" }
            ...
            NeonCard {
                ...
                Text { x: 20; y: 516; text: "Macro Gate"; color: "#71879b"; font.pixelSize: 9; font.family: "Segoe UI" }
                Text { x: 100; y: 516; width: 420; text: bot ? bot.macroGateText : "MACRO · FAIL-CLOSED"; color: macro && macro.allowNewTrade ? "#8fd2ff" : "#ff9a75"; font.pixelSize: 9; elide: Text.ElideRight; font.family: "Segoe UI" }
                Text { x: 20; y: 541; text: "Letzte Aktion"; color: "#71879b"; font.pixelSize: 9; font.family: "Segoe UI" }
                Text { x: 20; y: 560; width: 508; height: 28; text: bot ? bot.lastActionText : "—"; color: "#e5edf4"; font.pixelSize: 9; wrapMode: Text.WordWrap; elide: Text.ElideRight; font.family: "Segoe UI" }
            }
        }
        ...
        Item {
            ...
            NeonCard {
                ...
                Text { x: 20; y: 49; text: "TradePilot 0.16.3 · $10 REAL Pilot · Visible Scanner · REAL AUTO OFF"; color: "#8398ab"; font.pixelSize: 11; font.family: "Segoe UI" }
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "Multi-Source Economic Calendar 0.17.2 · Scanner Optimization · Visual Polish II · 1000 Stocks"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
