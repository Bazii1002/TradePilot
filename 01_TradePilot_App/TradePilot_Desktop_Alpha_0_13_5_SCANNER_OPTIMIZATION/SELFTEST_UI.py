...
print("TradePilot Desktop Alpha 0.13.5 SCANNER OPTIMIZATION SELFTEST: OK")
...
for marker in ["UNIVERSE", "SCANNED", "CANDIDATES", "BUY SIGNALS", "scannerDurationText"]:
...
# 0.13.5 scanner optimization checks
fast_src=(ROOT/"fast_scanner.py").read_text(encoding="utf-8")
