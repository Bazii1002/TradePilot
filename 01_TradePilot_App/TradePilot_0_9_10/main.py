...
class SettingsPage(QWidget):
    ...
    def __init__(self, config: dict, broker: PaperBroker, parent=None):
        ...
        warn = QLabel(loc(
            ...
            "Echte Broker-Orders bleiben in 0.9.10 vollständig deaktiviert.",
            "Note: If AutoTrader is active, scheduled scans may open or close paper trades. "
            "Real broker orders remain completely disabled in 0.9.10."))
        ...
        details = QLabel(
            ...
            "AutoTrader 0.9.10: Performance / Risk & Position Management / Börsenstatus / Order Engine / Auto-Refresh"
        )
