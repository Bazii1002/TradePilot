...
ApplicationWindow {
    ...
    visible: true
    color: "#010812"
    title: "TradePilot · " + (backend ? backend.version : "Desktop Alpha 0.13.4")
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { x: 84; y: 62; text: "Desktop Alpha 0.13.4"; color: "#6f8498"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        // PREMIUM VISUAL POLISH II 0.13.4: functional dashboard actions + upgraded surfaces/interactions
        // FUNCTIONAL PAGES ---------------------------------------------------------
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "Desktop Alpha 0.13.4 · Dashboard Actions · Visual Polish II · 1000 Stock Scanner"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
