...
ApplicationWindow {
    ...
    Dialog {
        ...
        contentItem: Item {
            ...
            TextField { id: liveAmount; x: 230; y: 130; width: 140; height: 42; text: "10"; color: "#f4f7fb"; font.pixelSize: 14; font.family: "Segoe UI"; validator: DoubleValidator { bottom: 0.01; top: 10.0; decimals: 2 }
                background: Rectangle { radius: 8; color: "#091a27"; border.color: "#23475f" } }
