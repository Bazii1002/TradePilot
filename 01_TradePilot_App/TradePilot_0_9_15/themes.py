...
THEMES = {
    "dark": {
        "bg":"#06101d", "sidebar":"#071321", "top":"#081522",
        "surface":"#0a1828", "surface2":"#0b1b2d", "surface3":"#10263d",
...
QLabel#Brand {{ font-size:22px; font-weight:760; letter-spacing:-0.5px; }}
...
QPushButton#NavButton {{background:transparent;border:0;border-radius:10px;text-align:left;padding:14px 14px;color:{p['muted']};font-size:13px;font-weight:600;}}
