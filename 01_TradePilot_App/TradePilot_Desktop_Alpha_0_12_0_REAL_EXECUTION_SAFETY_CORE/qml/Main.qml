...
ApplicationWindow {
    ...
    Rectangle {
        ...
        Text { x: 28; y: 66; text: "DESKTOP ALPHA 0.11.0"; color: window.textMuted; font.pixelSize: 9; font.family: "Segoe UI" }
        ...
        Text { x: 30; y: parent.height-49; text: "SHADOW / PAPER"; color: "#f2b84b"; font.pixelSize: 10; font.family: "Segoe UI" }
    }
        ...
        Item {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    Text { x:20; y:18; text:"Bot Activity · Stresstest"; color:window.textMain; font.pixelSize:16; font.bold:true; font.family:"Segoe UI" }
            ...
            Item {
                ...
                Rectangle { x:0;y:0;width:parent.width;height:150;radius:13;color:window.panel;border.color:window.line
                    ...
                    Text{x:22;y:51;text:"Der Bot-Stresstest läuft im Shadow/Paper-Modus. REAL Execution ist separat abgesichert; AutoTrading bleibt bis zur Produktionsstrategie gesperrt.";color:window.textMuted;font.pixelSize:11}
            ...
            Item{anchors.fill:parent;visible:window.currentPage===3
                Rectangle{anchors.fill:parent;radius:13;color:window.panel;border.color:window.line
                    ...
                    ListView{x:20;y:82;width:parent.width-40;height:570;clip:true;model:bot?JSON.parse(bot.marketRowsJson):[];delegate:Rectangle{width:ListView.view.width;height:52;color:index%2===0?window.panel2:"transparent";Text{x:12;anchors.verticalCenter:parent.verticalCenter;text:modelData.symbol;color:window.textMain;font.pixelSize:13;font.bold:true};Text{x:180;anchors.verticalCenter:parent.verticalCenter;text:"Stufe "+(bot?bot.level:2)+" · "+modelData.strategy;color:window.textMuted;font.pixelSize:10};Text{x:390;anchors.verticalCenter:parent.verticalCenter;text:"Score "+modelData.score+"%";color:window.textMain;font.pixelSize:11};Text{anchors.right:parent.right;anchors.rightMargin:18;anchors.verticalCenter:parent.verticalCenter;text:modelData.signal;color:modelData.signal==="BUY"?window.green:(modelData.signal==="WATCH"?"#f2b84b":window.textMuted);font.pixelSize:11;font.bold:true}}
                }
            }
            ...
            Item{anchors.fill:parent;visible:window.currentPage===6
                Rectangle{anchors.fill:parent;radius:13;color:window.panel;border.color:window.line
                    ...
                    Text{x:20;y:48;text:"Alle BUY/SELL-Aktionen des Stresstests. Jede Position behält ihre Eröffnungsstrategie.";color:window.textMuted;font.pixelSize:11}
            ...
            Item{anchors.fill:parent;visible:window.currentPage===7
                Rectangle{anchors.fill:parent;radius:13;color:window.panel;border.color:window.line
                    ...
                    Rectangle{x:20;y:186;width:520;height:126;radius:10;color:window.panel2;border.color:window.line
                        Text{x:16;y:14;text:"Stress Mode: SHADOW / PAPER";color:"#f2b84b";font.pixelSize:12;font.bold:true}
