...
ApplicationWindow {
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "UI Prototype 0.6.5 · Live Dashboard Foundation"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
}
