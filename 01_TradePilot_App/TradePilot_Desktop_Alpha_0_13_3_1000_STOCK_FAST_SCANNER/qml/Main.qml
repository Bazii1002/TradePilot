...
ApplicationWindow {
    ...
    visible: true
    color: "#010812"
    title: "TradePilot · " + (backend ? backend.version : "Desktop Alpha 0.13.3")
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { x: 84; y: 62; text: "Desktop Alpha 0.13.3"; color: "#6f8498"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        Item {
            ...
            NeonCard {
                ...
                Text { x: 20; y: 49; text: "~1.000 Aktien → Schnellscan → Top 50 → Deep Analysis · Cache + Batches + Parallelisierung"; color: "#8398ab"; font.pixelSize: 11; font.family: "Segoe UI" }

                Row {
                    x: 20; y: 78; spacing: 9
                    ScannerMetric { width: 210; height: 58; label: "UNIVERSE"; value: bot ? String(bot.universeCount) : "—"; detail: bot ? bot.scannerSourceText : ""; accentColor: "#2aa8ff" }
                    ScannerMetric { width: 210; height: 58; label: "SCANNED"; value: bot ? String(bot.scannerScanned) : "—"; detail: bot ? bot.scannerCacheText : ""; accentColor: "#24c9db" }
                    ScannerMetric { width: 210; height: 58; label: "CANDIDATES"; value: bot ? String(bot.scannerCandidates) : "—"; detail: "Fast Top 50"; accentColor: "#8d64ff" }
                    ScannerMetric { width: 210; height: 58; label: "DEEP"; value: bot ? String(bot.scannerDeep) : "—"; detail: "Production"; accentColor: "#5f8dff" }
                    ScannerMetric { width: 210; height: 58; label: "BUY SIGNALS"; value: bot ? String(bot.scannerSignals) : "—"; detail: "Shadow"; accentColor: "#2de487" }
                    ScannerMetric { width: 210; height: 58; label: "DURATION"; value: bot ? bot.scannerDurationText : "—"; detail: bot && bot.scannerErrors > 0 ? (bot.scannerErrors + " errors") : "OK"; accentColor: bot && bot.scannerErrors > 0 ? "#ff727d" : "#2de487" }
                }
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "Desktop Alpha 0.13.3 · 1000 Stock Fast Scanner · Production Signals"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
