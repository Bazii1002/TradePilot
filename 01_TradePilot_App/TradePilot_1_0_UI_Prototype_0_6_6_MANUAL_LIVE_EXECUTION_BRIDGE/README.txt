TradePilot 1.0 UI Prototype 0.6.6 — Manual LIVE Execution Bridge
...
Git-Workflow:
0.6.6 gehört zuerst auf dev. stable bleibt auf dem letzten getesteten Stand, bis 0.6.6 erfolgreich geprüft wurde.
