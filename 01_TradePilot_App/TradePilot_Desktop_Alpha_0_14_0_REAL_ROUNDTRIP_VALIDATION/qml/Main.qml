...
ApplicationWindow {
    ...
    visible: true
    color: "#010812"
    title: "TradePilot · " + (backend ? backend.version : "Desktop Alpha 0.14.0")
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { x: 84; y: 62; text: "Desktop Alpha 0.14.0"; color: "#6f8498"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        // PREMIUM VISUAL POLISH II 0.13.4 + FINAL SIGNAL QUALITY GATE 0.14.0: functional dashboard actions + upgraded surfaces/interactions
        // FUNCTIONAL PAGES ---------------------------------------------------------
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "Desktop Alpha 0.14.0 · Scanner Optimization · Visual Polish II · 1000 Stocks"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
