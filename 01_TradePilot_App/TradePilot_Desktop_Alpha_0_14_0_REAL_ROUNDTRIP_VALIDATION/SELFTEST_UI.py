...
print("TradePilot Desktop Alpha 0.14.0 FINAL SIGNAL QUALITY GATE SELFTEST: OK")
...
rt=(BASE / "real_execution.py").read_text(encoding="utf-8")
...
assert (BASE / "24_TEST_REAL_PREFLIGHT_NO_POST.bat").exists()
assert (BASE / "25_TEST_REAL_SAFETY_GATES_OFFLINE.bat").exists()
