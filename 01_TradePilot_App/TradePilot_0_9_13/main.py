...
class DashboardPage(QWidget):
    ...
    def __init__(self, broker: PaperBroker, parent=None):
        ...
        subtitle = QLabel(loc("Portfolio, AutoTrader und Marktstatus auf einen Blick.", "Portfolio, AutoTrader and market status at a glance.")); subtitle.setObjectName("Muted")
...
class TradePilotWindow(QMainWindow):
    ...
    def _build_sidebar(self):
        ...
        version = QLabel(f"Desktop  ·  {VERSION}")
        ...
        crown = QLabel("◆  TradePilot")
        crown.setStyleSheet(f"color:{YELLOW};font-weight:700;")
        note = QLabel(loc("Research + Broker Control\neToro REAL geschützt", "Research + Broker Control\neToro REAL protected"))
    ...
    def _build_topbar(self):
        ...
        avatar.setStyleSheet(f"background:{SURFACE_3};border:1px solid {BORDER};border-radius:18px;font-weight:750;color:{TEXT_2};")
        l.addWidget(avatar)
        return top
