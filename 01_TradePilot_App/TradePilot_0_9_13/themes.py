...
THEMES = {
    "dark": {
        "bg":"#06111f", "sidebar":"#071421", "top":"#081625",
        "surface":"#0a1928", "surface2":"#0c1d2f", "surface3":"#10243a",
        "border":"#18324a", "border2":"#24445f",
        "text":"#f4f8fc", "muted":"#9cafc3", "subtle":"#6f8499",
        "input":"#081725", "table":"#091827", "header":"#0d2032",
        "selection":"#0d3155", "grid":"#142c42", "scroll":"#29445e"
    },
    "light": {
...
QFrame#Card, QFrame#HeroCard, QFrame#Panel {{ background:{p['surface']}; border:1px solid {p['border']}; border-radius:13px; }}
QFrame#HeroCard {{ border-color:{p['border2']}; }}
QFrame#MetricCard {{ background:{p['surface2']}; border:1px solid {p['border']}; border-radius:13px; }}
...
QPushButton#NavButton {{background:transparent;border:0;border-radius:9px;text-align:left;padding:11px 13px;color:{p['muted']};font-weight:600;}}
