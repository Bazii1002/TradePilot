    ...
    Item {
        ...
        Item {
            ...
            NeonCard {
                ...
                Text { x: 20; y: 527; text: "Letzte Aktion"; color: "#71879b"; font.pixelSize: 10; font.family: "Segoe UI" }
                Text { x: 20; y: 549; width: 508; height: 36; text: bot ? bot.lastActionText : "—"; color: "#e5edf4"; font.pixelSize: 10; wrapMode: Text.WordWrap; font.family: "Segoe UI" }
            }
        }
