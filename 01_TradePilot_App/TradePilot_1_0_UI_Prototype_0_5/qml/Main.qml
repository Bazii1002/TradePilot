...
ApplicationWindow {
    ...
    property var navIcons: ["../assets/icons/dashboard.svg", "../assets/icons/bot.svg", "../assets/icons/portfolio.svg", "../assets/icons/markets.svg", "../assets/icons/news.svg", "../assets/icons/backtest.svg", "../assets/icons/trades.svg", "../assets/icons/settings.svg"]
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { x: 84; y: 62; text: "1.0 · UI Prototype 0.5"; color: "#6f8498"; font.pixelSize: 10; font.family: "Segoe UI" }
            ...
            Column {
                ...
                Repeater {
                    ...
                    NavItem {
                        ...
                        onClicked: { window.currentPage=index; backend.navigationClicked(label) }
                    }
                }
            }
            ...
            NeonCard {
                ...
                Text { x: 17; y: 43; text: backend.marketTime; color: "#f6f8fb"; font.pixelSize: 23; font.weight: Font.DemiBold; font.family: "Segoe UI" }
                Text { x: 17; y: 75; text: backend.dateText; color: "#748a9e"; font.pixelSize: 11; font.family: "Segoe UI" }
        ...
        Rectangle {
            ...
            Image { x: 1245; y: 28; width: 30; height: 30; source: "../assets/icons/bell.svg"; fillMode: Image.PreserveAspectFit; smooth: true }
            ...
            Rectangle {
                ...
                Image { anchors.centerIn: parent; width: 31; height: 31; source: "../assets/icons/profile.svg"; fillMode: Image.PreserveAspectFit; smooth: true }
            }
        }
        ...
        Item {
            ...
            MetricCard { x: 0; y: 0; width: 335; height: 174; title: "Cash Available"; value: "$18,742.63"; subtitleLeft: "Buying Power"; subtitleRight: "$18,742.63"; iconSource: "../assets/icons/cash.svg"; accentColor: "#29a9ff" }
            MetricCard { x: 351; y: 0; width: 335; height: 174; title: "Invested"; value: "$82,317.58"; subtitleLeft: "In Positions"; subtitleRight: "84.2% of Portfolio"; iconSource: "../assets/icons/invested.svg"; accentColor: "#2de487" }
            MetricCard { x: 702; y: 0; width: 335; height: 174; title: "Portfolio Value"; value: "$101,060.21"; subtitleLeft: "Total Value"; subtitleRight: "$101,060.21"; iconSource: "../assets/icons/value.svg"; accentColor: "#8d64ff" }
            MetricCard { x: 1053; y: 0; width: 335; height: 174; title: "Today"; value: "+$1,412.63"; subtitleLeft: "+1.41%"; subtitleRight: ""; iconSource: "../assets/icons/today.svg"; accentColor: "#25aaff"; valueColor: "#35df8b"; sparkline: true }
            ...
            NeonCard {
                ...
                Column {
                    x: 20; y: 82; width: 340
                    TradeRow { width: 340; symbol: "AAPL"; company: "Apple Inc."; side: "BUY"; amount: "$5,320.00"; shares: "20 Shares"; time: "10:31:22 AM"; logoSource: "../../assets/company/aapl.png" }
                    TradeRow { width: 340; symbol: "NVDA"; company: "NVIDIA Corp."; side: "SELL"; amount: "$3,850.40"; shares: "10 Shares"; time: "10:22:11 AM"; logoSource: "../../assets/company/nvda.png" }
                    TradeRow { width: 340; symbol: "MSFT"; company: "Microsoft Corp."; side: "BUY"; amount: "$4,100.00"; shares: "25 Shares"; time: "10:15:08 AM"; logoSource: "../../assets/company/msft.png" }
                    TradeRow { width: 340; symbol: "TSLA"; company: "Tesla, Inc."; side: "SELL"; amount: "$2,760.00"; shares: "12 Shares"; time: "09:58:47 AM"; logoSource: "../../assets/company/tsla.png" }
                    TradeRow { width: 340; symbol: "SPY"; company: "SPDR S&P 500 ETF"; side: "BUY"; amount: "$1,875.50"; shares: "15 Shares"; time: "09:41:33 AM"; logoSource: "../../assets/company/spy.png" }
                }
            ...
            NeonCard {
                ...
                Column {
                    x: 20; y: 54; width: 476
                    NewsRow { width: 476; imageSource: "../../assets/news/fed.png"; badge: "FED"; titleText: "Fed Minutes Signal Caution on Rate Cuts"; subtitle: "Officials emphasize data dependency amid persistent inflation risks."; timeText: "7m ago"; badgeColor: "#0e3b69" }
                    NewsRow { width: 476; imageSource: "../../assets/news/nasdaq.png"; badge: "NASDAQ"; titleText: "NASDAQ Rallies on Tech Earnings Beat"; subtitle: "Strong results from AI and cloud giants fuel market optimism."; timeText: "29m ago"; badgeColor: "#39206f" }
                    NewsRow { width: 476; imageSource: "../../assets/news/btc.png"; badge: "BTC"; titleText: "Bitcoin Holds Above $67K as ETF Inflows Rise"; subtitle: "Institutional demand continues to support bullish momentum."; timeText: "46m ago"; badgeColor: "#5a3507" }
                    NewsRow { width: 476; imageSource: "../../assets/news/europe.png"; badge: "EUROPE"; titleText: "European Markets Mixed Ahead of ECB Meet"; subtitle: "Investors await guidance as growth outlook remains uncertain."; timeText: "1h ago"; badgeColor: "#083f73" }
                }
            }
            ...
            NeonCard {
                ...
                Image { x: 35; y: 66; width: 76; height: 76; source: "../assets/ui/bot.png"; fillMode: Image.PreserveAspectFit; smooth: true; mipmap: true }
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "UI Prototype 0.5 · Final Visual Match"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
}
