...
Item {
    ...
    Rectangle {
        ...
        color: "#0d2232"; border.width: 1; border.color: "#23465f"
    ...
    Text { x: 164; y: 20; text: root.side; color: (root.side === "BUY" || root.side === "OPEN") ? "#2EE890" : "#FF5666"; font.pixelSize: 12; font.weight: Font.DemiBold; font.family: "Segoe UI" }
