...
class BotOrb(QWidget):
    ...
    def paintEvent(self,event):
        ...
        p.setBrush(QBrush(QColor('#EAF7FF'))); p.setPen(Qt.NoPen); p.drawRoundedRect(c.x()-22,c.y()-14,44,31,12,12)
        p.setBrush(QColor('#102436')); p.drawRoundedRect(c.x()-15,c.y()-8,30,17,8,8)
...
class TradePilotWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("TradePilot Desktop Alpha 0.10.2 · Exact Dashboard Design")
    ...
    def _build_ui(self):
        ...
        version = QLabel("1.0 · UI Prototype 0.10.2")
