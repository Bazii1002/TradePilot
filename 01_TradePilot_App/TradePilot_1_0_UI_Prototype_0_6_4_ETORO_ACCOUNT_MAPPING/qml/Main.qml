...
ApplicationWindow {
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { x: 84; y: 62; text: "1.0 · UI Prototype 0.6"; color: "#6f8498"; font.pixelSize: 10; font.family: "Segoe UI" }
            ...
            Text { x: 27; y: 894; width: 186; text: "Backend Bridge · eToro READ ONLY"; color: "#4f687c"; font.pixelSize: 9; horizontalAlignment: Text.AlignHCenter; font.family: "Segoe UI" }
        }
        ...
        Rectangle {
            ...
            MarketPill { x: 708; y: 19; market: "NYSE"; stateText: backend ? backend.nyseState : "—"; subText: backend ? backend.nyseSub : ""; open: backend ? backend.nyseOpen : false }
            MarketPill { x: 873; y: 19; market: "NASDAQ"; stateText: backend ? backend.nasdaqState : "—"; subText: backend ? backend.nasdaqSub : ""; open: backend ? backend.nasdaqOpen : false }
            MarketPill { x: 1038; y: 19; width: 178; market: "XETRA"; stateText: backend ? backend.xetraState : "—"; subText: backend ? backend.xetraSub : ""; open: backend ? backend.xetraOpen : false }
        ...
        Item {
            ...
            MetricCard { x: 702; y: 0; width: 335; height: 174; title: "Portfolio Value"; value: backend ? backend.portfolioText : "—"; subtitleLeft: "eToro REAL"; subtitleRight: backend ? backend.portfolioText : "—"; iconSource: Qt.resolvedUrl("../assets/icons/value.svg"); accentColor: "#8d64ff" }
            ...
            NeonCard {
                ...
                Text { x: 143; y: 160; text: backend ? ("◷  Datenrefresh: " + backend.lastRefreshText) : "◷  Noch nicht aktualisiert"; color: "#8ea2b5"; font.pixelSize: 10; font.family: "Segoe UI" }
        ...
        Rectangle {
            ...
            Text { anchors.right: parent.right; anchors.rightMargin: 16; anchors.verticalCenter: parent.verticalCenter; text: "UI Prototype 0.6 · Runtime Fix"; color: "#536d83"; font.pixelSize: 9; font.family: "Segoe UI" }
        }
    }
}
