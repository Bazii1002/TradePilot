...
0.6.4 ACCOUNT MAPPING
- clientPortfolio.credit -> Cash / Buying Power
- explicit empty positions[] -> Invested = 0.00
- clientPortfolio.unrealizedPnL from REAL P/L -> Open P/L
- accountCurrencyId 1 -> USD
- Portfolio Value is conservatively derived as credit + invested + unrealized P/L
- bonusCredit remains separate and is not silently counted in Portfolio Value
- Today remains unavailable unless eToro returns an explicit daily P/L field
- READ ONLY: no order endpoints or write HTTP methods
