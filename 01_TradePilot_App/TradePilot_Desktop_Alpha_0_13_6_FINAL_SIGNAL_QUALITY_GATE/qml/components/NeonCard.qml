...
Item {
    ...
    Rectangle {
        ...
        color: "transparent"
        border.width: 6
        border.color: Qt.rgba(root.accentColor.r, root.accentColor.g, root.accentColor.b, 0.040)
        opacity: 0.95
    }
    Rectangle {
        visible: root.glow
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            color: Qt.rgba(root.accentColor.r, root.accentColor.g, root.accentColor.b, 0.060)
        }

        Rectangle {
            x: 18; y: 1; width: parent.width - 36; height: 1
            color: "#DDF3FF"; opacity: 0.105
        }
