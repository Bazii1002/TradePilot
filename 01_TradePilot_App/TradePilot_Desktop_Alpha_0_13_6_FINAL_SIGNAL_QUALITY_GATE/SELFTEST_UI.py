...
print("TradePilot Desktop Alpha 0.13.6 FINAL SIGNAL QUALITY GATE SELFTEST: OK")
...
# 0.13.6 scanner optimization checks
fast_src=(ROOT/"fast_scanner.py").read_text(encoding="utf-8")
...
assert "FINAL SIGNAL QUALITY GATE 0.13.6" in qml_src
...
# 0.13.6 Final Signal Quality Gate
