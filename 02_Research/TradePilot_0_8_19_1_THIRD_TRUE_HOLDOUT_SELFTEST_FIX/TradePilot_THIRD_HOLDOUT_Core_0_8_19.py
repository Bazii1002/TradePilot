...
# ============================================================
# TRADEPILOT 0.8.19 THIRD TRUE HOLDOUT - KERNLOGIK 0.6.1
#
# Ziele:
...
def main():
    ...
    print()
    print("=" * 100)
    print("TRADEPILOT BACKTEST 0.8.19 THIRD TRUE HOLDOUT RAW")
    print("=" * 100)
    ...
    datei = f"TradePilot_Backtest_0.8.19_THIRD_HOLDOUT_RAW_{stempel}.csv"
    df.to_csv(datei, index=False, encoding="utf-8-sig")

    # 0.8.19 ist absichtlich KEIN Explorationslauf.
    # Keine Schwellenmatrix und kein Kandidaten-Score-Audit:
    # die Rohbeobachtungen werden nur von der separaten, eingefrorenen
    # eingefrorenen H1-FIRST-SIGNAL-Auswertung gelesen.
    ...
    print("=" * 100)
    print("Backtest 0.8.19 THIRD TRUE HOLDOUT RAW beendet.")
