...
# ============================================================
# TRADEPILOT 0.8.15 SECOND TRUE HOLDOUT - KERNLOGIK 0.6.1
#
# Ziele:
...
def main():
    ...
    print()
    print("=" * 100)
    print("TRADEPILOT BACKTEST 0.8.15 SECOND TRUE HOLDOUT RAW")
    print("=" * 100)
    ...
    print("=" * 100)
    print("Backtest 0.8.15 SECOND TRUE HOLDOUT RAW beendet.")
