...
def main():
    ...
    print()
    print("=" * 100)
    print("TRADEPILOT BACKTEST 0.8.5.1 SCORE AUDIT FIX")
    print("=" * 100)
    ...
    datei = f"TradePilot_Backtest_0.8.5.1_SCORE_AUDIT_FIX_{stempel}.csv"
    df.to_csv(datei, index=False, encoding="utf-8-sig")

    matrix_df = auswertung(df)

    matrix_datei = f"TradePilot_Schwellenmatrix_0.8.5.1_SCORE_AUDIT_FIX_{stempel}.csv"
    matrix_df.to_csv(matrix_datei, index=False, encoding="utf-8-sig")

    audit_df = score_audit_auswertung(df)
    audit_datei = f"TradePilot_ScoreAudit_0.8.5.1_{stempel}.csv"
    ...
    print("=" * 100)
    print("Backtest 0.8.5.1 SCORE AUDIT FIX beendet.")
